...
const en = {
  ...
  constructor: {
    ...
    addExercisePlan:    'Add exercise to workout',
    phaseLabels: {
      warmup:   'Warm-up',
      strength: 'Strength Block',
      cardio:   'Cardio',
    ...
    generateAIDesc:     'Describe what you want — Groq will pick an exercise',
    addManual:          'Add manually',
    addManualDesc:      'Enter name, sets and reps yourself',
    changeWorkout:      'Change workout',
    workout:            'Workout:',
    // AI mode
    phaseType:          'Exercise type',
    describeExercise:   'Describe the exercise',
    describePlaceholder:'E.g.: glute exercise with no equipment, or: 30-second cardio, or: shoulder warm-up...',
    back:               'Back',
    ...
    add:                'Add',
    // Preview
    setsReps:           (sets: number, reps: string) => `${sets} sets × ${reps}`,
    rest:               (s: number) => `Rest ${s}s`,
    // Manual mode
    exerciseName:       'Exercise name',
    exerciseNamePlaceholder: 'E.g.: Barbell Squat',
    sets:               'Sets',
    reps:               'Reps',
    restSec:            'Rest (s)',
    muscleGroup:        'Muscle group',
    muscleGroupPlaceholder: 'Legs, Back...',
    equipment:          'Equipment',
    equipmentPlaceholder:   'Dumbbells, Pull-up bar...',
    phaseLabel:         'Workout phase',
    descriptionLabel:   'Technique description (optional)',
    descriptionPlaceholder: 'Brief technique description...',
...
const ru: Dict = {
  ...
  generatePlan: {
    ...
    step4SessionsPerWeek: 'Тренировок в неде��ю',
    step4TrainingDays:    'Дни тренировок',
    step4StartDate:       'Дата начала',
    step5Title:    'Пожелания к тренировке',
    step5Desc:     'Напиши любые пожелания или ограничения — они будут учтены при составле��ии плана.',
  ...
  rest_label:      'Отдых',
    ...
    progressLabel:    'Прог��есс тренировки',
    readyLabel:       'готово!',
  ...
  constructor: {
    ...
    addExercisePlan:    'Добавить упражнение в тренировку',
    phaseLabels: {
      warmup:   'Разминка',
      strength: 'Силовой блок',
      cardio:   'Кардио',
    ...
    chooseWorkout:      'Выбрать тренировку',
    generateAI:         'Сгенерировать через AI',
    generateAIDesc:     'Опишите что хотите — Groq подберет упражнение',
    addManual:          'Добавить вручную',
    addManualDesc:      'Введите название, подходы и повторения самостоятельно',
    changeWorkout:      'Изменить тренировку',
    workout:            'Тренировка:',
    phaseType:          'Тип тренировки',
    describeExercise:   'Опишите упражнение',
    describePlaceholder:'Например: упражнение на ягодицы без инвентаря, или: кардио на 30 секунд, или: разминка для плеч...',
    back:               'Назад',
    generating:         'Генерирую...',
    generate:           'Сгенерировать',
    regenerate:         'Перегенерировать',
    add:                'Добавить',
    setsReps:           (sets: number, reps: string) => `${sets} подх. × ${reps}`,
    rest:               (s: number) => `Отдых ${s}с`,
    exerciseName:       'Название упражнения',
    exerciseNamePlaceholder: 'Например: Приседания со штангой',
    sets:               'Подходы',
    reps:               'Повторения',
    restSec:            'Отдых (с)',
    muscleGroup:        'Группа мышц',
    muscleGroupPlaceholder: 'Ноги, Спина...',
    equipment:          'Инвентарь',
    equipmentPlaceholder:   'Гантели, Турник...',
    phaseLabel:         'Фаза тренировки',
    descriptionLabel:   'Описание техники (необязательно)',
    descriptionPlaceholder: 'Краткое описание техники...',
